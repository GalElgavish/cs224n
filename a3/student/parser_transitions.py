...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        for partial_parse, transition in zip(unfinished_parses[:batch_size], transitions):
            partial_parse.parse_step(transition=transition)
        for partial_parse in list(unfinished_parses[:batch_size]):
