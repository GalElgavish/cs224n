...
if args.function == 'pretrain':
    ...
    name_dataset = dataset.NameDataset(pretrain_dataset, open(args.finetune_corpus_path, encoding='utf-8').read())
    model = model.GPT(mconf)
    trainer_config = trainer.TrainerConfig(ckpt_path=args.writing_params_path)
    model_trainer = trainer.Trainer(model, name_dataset, None, trainer_config)
    model_trainer.train()
